      ...
      <div className="hero__container">
        <div className="hero-content">
          <div className="hero-info">
            ...
            <h1 className="hero-info__title">
              CONSTRUINDO SONHOS COM O MEU CÓDIGO
            </h1>
            <p className="hero-info__desc">
              Eai! Meu nome é <strong>Matheus Kristman</strong> e sou
              Desenvolvedor Web <strong>Front-end</strong>. Eu ajudo empresas,
              pequenos negócios e designers a trazerem suas ideias a vida e
              conquistarem o seu espaço na internet.
            </p>
            <div className="hero-info__btn-container">
              <button type="button" className="work-btn">
                Conheça Meu Trabalho
              </button>
              <button type="button" className="hero-contact-btn">
                Fale Comigo
              </button>
            </div>
          </div>
