                ...
                <div className="hero-content">
                    <div className="hero-info">
                        ...
                        <motion.p
                            ...
                            initial="hidden"
                            animate={control}
                            className="hero-info__desc"
                        >
                            Eai! Meu nome é <strong>Matheus Kristman</strong> e
                            sou Desenvolvedor Web <strong>FullStack</strong>. Eu
                            ajudo empresas, pequenos negócios e designers a
                            trazerem suas ideias a vida e conquistarem o seu
                            espaço na internet.
                        </motion.p>
